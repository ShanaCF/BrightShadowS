The goal of this part of the BSS project is to get a working plugin coded for Blender that can import/export renderware 3.7 ANM BSP and DFF files. This folder contains source code gathered up from the web that claims to be renderware 3.7 compatable.


Links to older renderware versions

Old renderware rwx format:
https://github.com/adamaig/blender_rwx_importer

Renderware 3.5 userguide
